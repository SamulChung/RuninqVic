...
function buildDocx() {
  ...
  const doc = new Document({
    ...
    sections: [{
      ...
      headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT, children: [run('RuninqVic 사용설명서 v1.5  ·  제작: (주)텐에이아이 www.tenai.kr', { size: 16, color: GRAY })], border: { bottom: { style: BorderStyle.SINGLE, size: 4, color: 'DDDDDD', space: 4 } } })] }) },
